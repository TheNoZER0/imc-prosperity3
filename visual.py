...
class Trade:
    ...
    def basket_1(basket: Status, jam: Status, djembes: Status, croissant: Status) -> list[Order]:
        ...
        orders = []
        orders.extend(Strategy.index_arb(basket, jam, djembes, croissant, theta = 3.65410486e-07, threshold=68*1.06727851/math.sqrt(2*1.05678874e+01), jam_m = 3, croiss_m = 6, djembe_m = 1))
    ...
    def basket_2(basket: Status, jam: Status, djembes: Status, croissant: Status) -> list[Order]:
        ...
        orders = []
        orders.extend(Strategy.index_arb(basket, jam, djembes, croissant, theta = 1.33444695e+01, threshold=47*7.76577306e+00/math.sqrt(2*1.33444695e+01), jam_m = 2, croiss_m = 4, djembe_m = 0))
