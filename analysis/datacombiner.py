...
trades_day_minus2 = pd.read_csv('../data/round3/trades_round_3_day_0.csv', delimiter=';')
trades_day_minus2['day'] = -1

trades_day_minus1 = pd.read_csv('../data/round3/trades_round_3_day_1.csv', delimiter=';')
trades_day_minus1['day'] = 0

trades_day_0 = pd.read_csv('../data/round3/trades_round_3_day_2.csv', delimiter=';')
trades_day_0['day'] = 1
...
trades_df.to_csv('trades_combined_r3.csv', index=False, sep=';')


# --- Process the Prices Data ---

df_day_minus2 = pd.read_csv('../data/round3/prices_round_3_day_0.csv', delimiter=';')
df_day_minus1 = pd.read_csv('../data/round3/prices_round_3_day_1.csv', delimiter=';')
df_day_0 = pd.read_csv('../data/round3/prices_round_3_day_2.csv', delimiter=';')
...
prices_df.to_csv('prices_combined_r3.csv', index=False, sep=';')
