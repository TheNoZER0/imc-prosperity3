...
df_day_minus2 = pd.read_csv('../data/prevyear/prices_round_2_day_-1.csv', delimiter=';')
df_day_minus1 = pd.read_csv('../data/prevyear/prices_round_2_day_0.csv', delimiter=';')
df_day_0 = pd.read_csv('../data/prevyear/prices_round_2_day_1.csv', delimiter=';')
...
prices_df.to_csv('prices_combined_prev.csv', index=False, sep=';')
