...
trades_day_minus2 = pd.read_csv('../data/round5/trades_round_5_day_2.csv', delimiter=';')
trades_day_minus2['day'] = 1

trades_day_minus1 = pd.read_csv('../data/round5/trades_round_5_day_3.csv', delimiter=';')
trades_day_minus1['day'] = 2

trades_day_0 = pd.read_csv('../data/round5/trades_round_5_day_4.csv', delimiter=';')
trades_day_0['day'] = 3
...
trades_df.to_csv('trades_combined_r5.csv', index=False, sep=';')


# -- Observations --

observations_day_minus2 = pd.read_csv('../data/round5/observations_round_5_day_2.csv', delimiter=',')
observations_day_minus2['day'] = 1

observations_day_minus1 = pd.read_csv('../data/round5/observations_round_5_day_3.csv', delimiter=',')
observations_day_minus1['day'] = 2

observations_day_0 = pd.read_csv('../data/round5/observations_round_5_day_4.csv', delimiter=',')
...
observations_df.to_csv('observations_combined_r5.csv', index=False, sep=';')


# --- Process the Prices Data ---

df_day_minus2 = pd.read_csv('../data/round5/prices_round_5_day_2.csv', delimiter=';')
df_day_minus1 = pd.read_csv('../data/round5/prices_round_5_day_3.csv', delimiter=';')
df_day_0 = pd.read_csv('../data/round5/prices_round_5_day_4.csv', delimiter=';')
...
prices_df.to_csv('prices_combined_r5.csv', index=False, sep=';')
