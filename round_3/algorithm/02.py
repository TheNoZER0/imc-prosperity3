...
## GRID SEARCH
VOL_DIFFERENCE_THRESHOLD_GS = 0.015 # 0.01 default
TRADE_QUANTITY_GS = 50 # 20 default
...
class Trader:
    ...
    def run(self, state: TradingState) -> tuple[dict[Symbol, list[Order]], int, str]:
        ...
        if fitted_curve is not None: 
            vol_difference_threshold = VOL_DIFFERENCE_THRESHOLD_GS
        ...
        trade_quantity = TRADE_QUANTITY_GS
